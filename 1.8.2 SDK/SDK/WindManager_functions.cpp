...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FTransform&                Particle_Transform                                     (Parm, IsPlainOldData, NoDestructor)
...
// Parameters:
// const struct FFortWindImpulseCylinder&  WindImpulseCylinder                                    (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor)
...
// Parameters:
// const struct FFortWindImpulseCylinder&  WindImpulseCylinder                                    (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor)
// const struct FFortWindImpulseCylinderDelta&WindImpulseCylinderDelta                               (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor)
...
// Parameters:
// const struct FFortWindImpulseCylinder&  Wind_Impulse                                           (Parm, NoDestructor)
// const struct FFortWindImpulseCylinderDelta&Wind_Delta                                             (Parm, NoDestructor)
...
// const struct FVector&                   AnimatedCylinderCenter                                 (Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// const struct FVector&                   CylinderCenter                                         (Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    Set_WindVector                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// const struct FVector&                   WindVector                                             (Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    Set_WindCrossVector                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// const struct FVector&                   WindCrossVector                                        (Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FVector&                   Wind_location                                          (Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool*                                   Storm_Cyl_Mesh_Match_0                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_ExecuteUbergraph_MissionTrackerSubEntry;
...
public:
	...
	TDelegate<void(class AFortMissionState* MissionState, const struct FGameplayTagContainer& EventTags)> K2Node_CreateDelegate_OutputDelegate2; // 0x0018(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const class AFortObjectiveBase* Objective, EFortObjectiveStatus NewStatus)> K2Node_CreateDelegate_OutputDelegate4; // 0x0038(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(const class AFortObjectiveBase* Objective, bool bNewVisibility)> K2Node_CreateDelegate_OutputDelegate5; // 0x0048(0x0010)(ZeroConstructor, NoDestructor)
};
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_Setup;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_HandleObjectiveStatusChanged;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_HandleObjectiveVisibilityChanged;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_HandleUpdate;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_HideObjectiveWidget;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_StartEndingAnimations;
...
public:
	...
	bool                                          CallFunc_NotEqual_ClassClass_ReturnValue2;         // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UPanelSlot*                             CallFunc_AddChild_ReturnValue2;                    // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_DoesImplementInterface_ReturnValue3;      // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_CreateObjectiveContentWidget;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_HanldeObjectiveVisiblityOverrideChanged;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_ShowObjectiveWidget;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_Update;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_HandleMissionUIEvent;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_CreateCompletionAnnouncement;
...
DUMPER7_ASSERTS_MissionTrackerSubEntry_C_GetHeightEstimate;

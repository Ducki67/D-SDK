...
void UHalloweenQuestsTile_C::SetQuestPlayButton()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HalloweenQuestsTile_C", "SetQuestPlayButton");
...
void UHalloweenQuestsTile_C::TrySetQuestButton(class UFortQuestItem* Quest, bool* CanPlayQuest)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HalloweenQuestsTile_C", "TrySetQuestButton");

	Params::HalloweenQuestsTile_C_TrySetQuestButton Parms{};
...
void UHalloweenQuestsTile_C::PopulateMainQuestArray()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HalloweenQuestsTile_C", "PopulateMainQuestArray");

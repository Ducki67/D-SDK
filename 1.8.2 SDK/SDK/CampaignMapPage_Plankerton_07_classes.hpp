...
// WidgetBlueprintGeneratedClass CampaignMapPage_Plankerton_07.CampaignMapPage_Plankerton_07_C
// 0x0078 (0x02B0 - 0x0238)
class UCampaignMapPage_Plankerton_07_C final : public UCommonUserWidget
{
public:
...
public:
	void ExecuteUbergraph_CampaignMapPage_Plankerton_07(int32 EntryPoint);
	void Construct();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("CampaignMapPage_Plankerton_07_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"CampaignMapPage_Plankerton_07_C")
	}
	static class UCampaignMapPage_Plankerton_07_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCampaignMapPage_Plankerton_07_C>();
	}
};
DUMPER7_ASSERTS_UCampaignMapPage_Plankerton_07_C;

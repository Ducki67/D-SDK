...
{
public:
	bool                                          IsConfigE;                                         // 0x0000(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          IsConfigF;                                         // 0x0001(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2[0x6];                                        // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 ConfigE;                                           // 0x0008(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash)
	class FString                                 ConfigF;                                           // 0x0018(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash)
	bool                                          ShowDoubleKeysTop;                                 // 0x0028(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          ShowDoubleKeysBottom;                              // 0x0029(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          IsPreviousSlot;                                    // 0x002A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          IsFocusedSlot;                                     // 0x002B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
	int32                                         FocusedSlotIndex;                                  // 0x002C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              CallFunc_GetVisibility_ReturnValue;                // 0x0030(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              CallFunc_GetVisibility_ReturnValue2;               // 0x0031(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	ESlateVisibility                              CallFunc_GetVisibility_ReturnValue3;               // 0x0037(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
DUMPER7_ASSERTS_AthenaQuickBarSlot_C_UpdateKeyBindingText_SpecialCases;
...
DUMPER7_ASSERTS_AthenaQuickBarSlot_C_GetKeyBindingAction_Gamepad;

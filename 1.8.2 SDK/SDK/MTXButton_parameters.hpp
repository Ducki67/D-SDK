...
public:
	...
	struct FFortPrivateAccountInfo                K2Node_CustomEvent_NewInfo;                        // 0x0020(0x0028)(NoDestructor)
	...
	EFortUIFeatureState                           CallFunc_GetFeatureState_ReturnValue;              // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsInZone_ReturnValue;                     // 0x0059(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UFortMcpContext*                        CallFunc_GetContext_ReturnValue3;                  // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortPrivateAccountInfo                CallFunc_GetLocalAccountInfo_Result;               // 0x0068(0x0028)(NoDestructor)
	float                                         CallFunc_Conv_IntToFloat_ReturnValue;              // 0x0090(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_CustomEvent_bUsingGamepad;                  // 0x0094(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_95[0x3];                                       // 0x0095(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(const struct FFortPrivateAccountInfo& NewInfo)> K2Node_CreateDelegate_OutputDelegate2; // 0x0098(0x0010)(ZeroConstructor, NoDestructor)
...
DUMPER7_ASSERTS_MTXButton_C_HandleInputActionChnaged;
...
DUMPER7_ASSERTS_MTXButton_C_BndEvt__VBucksButton_K2Node_ComponentBoundEvent_5_CommonButtonClicked__DelegateSignature;
...
{
public:
	struct FFortPrivateAccountInfo                NewInfo;                                           // 0x0000(0x0028)(Parm, NoDestructor)
};
DUMPER7_ASSERTS_MTXButton_C_HandleLocalAccountInfoChanged;
...
{
public:
	struct FFortPrivateAccountInfo                FortPrivateAccountInfo;                            // 0x0000(0x0028)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor)
	float                                         CallFunc_Conv_IntToFloat_ReturnValue;              // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_MTXButton_C_UpdateAmount;
...
DUMPER7_ASSERTS_MTXButton_C_Get_Button_ToolTipWidget_0;
...
DUMPER7_ASSERTS_MTXButton_C_UpdateState;

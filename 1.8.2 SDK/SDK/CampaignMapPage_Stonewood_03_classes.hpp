...
// WidgetBlueprintGeneratedClass CampaignMapPage_Stonewood_03.CampaignMapPage_Stonewood_03_C
// 0x0078 (0x02B0 - 0x0238)
class UCampaignMapPage_Stonewood_03_C final : public UCommonUserWidget
{
public:
	...
	class UImage*                                 Img_Component;                                     // 0x0258(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
public:
	void ExecuteUbergraph_CampaignMapPage_Stonewood_03(int32 EntryPoint);
	void Construct();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("CampaignMapPage_Stonewood_03_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"CampaignMapPage_Stonewood_03_C")
	}
	static class UCampaignMapPage_Stonewood_03_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCampaignMapPage_Stonewood_03_C>();
	}
};
DUMPER7_ASSERTS_UCampaignMapPage_Stonewood_03_C;

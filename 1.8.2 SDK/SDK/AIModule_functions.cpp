...
class UAITask_MoveTo* UAITask_MoveTo::AIMoveTo(class AAIController* Controller, const struct FVector& GoalLocation, class AActor* GoalActor, float AcceptanceRadius, EAIOptionFlag StopOnOverlap, EAIOptionFlag AcceptPartialPath, bool bUsePathfinding, bool bLockAILogic, bool bUseContinuosGoalTracking)
{
...
int32 UNavLocalGridManager::AddLocalNavigationGridForBox(class UObject* WorldContext, const struct FVector& Location, const struct FVector& Extent, const struct FRotator& Rotation, const int32 Radius2D, const float Height, bool bRebuildGrids)
{
	static class UFunction* Func = nullptr;
...
int32 UNavLocalGridManager::AddLocalNavigationGridForCapsule(class UObject* WorldContext, const struct FVector& Location, float CapsuleRadius, float CapsuleHalfHeight, const int32 Radius2D, const float Height, bool bRebuildGrids)
{
	static class UFunction* Func = nullptr;
...
int32 UNavLocalGridManager::AddLocalNavigationGridForPoint(class UObject* WorldContext, const struct FVector& Location, const int32 Radius2D, const float Height, bool bRebuildGrids)
{
	static class UFunction* Func = nullptr;
...
void UNavLocalGridManager::RemoveLocalNavigationGrid(class UObject* WorldContext, int32 GridId, bool bRebuildGrids)
{
	static class UFunction* Func = nullptr;

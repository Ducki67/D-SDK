...
DUMPER7_ASSERTS_MissionObjectiveProgressBarsManager_C_UpdateObjectiveProgressBars;
...
public:
	...
	TDelegate<void(const class AFortObjectiveBase* Objective, bool bNewVisibility)> K2Node_CreateDelegate_OutputDelegate2; // 0x0020(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(const class AFortObjectiveBase* Objective, EFortObjectiveStatus NewStatus)> K2Node_CreateDelegate_OutputDelegate3; // 0x0030(0x0010)(ZeroConstructor, NoDestructor)
};
DUMPER7_ASSERTS_MissionObjectiveProgressBarsManager_C_Setup;
...
DUMPER7_ASSERTS_MissionObjectiveProgressBarsManager_C_CreateProgressBarWidget;
...
DUMPER7_ASSERTS_MissionObjectiveProgressBarsManager_C_HandleObjectiveStatusChanged;
...
DUMPER7_ASSERTS_MissionObjectiveProgressBarsManager_C_HandleObjectiveVisibilityChanged;
...
DUMPER7_ASSERTS_MissionObjectiveProgressBarsManager_C_HandleUpdate;
...
DUMPER7_ASSERTS_MissionObjectiveProgressBarsManager_C_GetHeightEstimate;

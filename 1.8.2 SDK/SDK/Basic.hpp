...
namespace Offsets
{
	constexpr int32 GObjects          = 0x067AD690;
	constexpr int32 AppendString      = 0x013480C0;
	constexpr int32 GNames            = 0x067A4AC8;
	constexpr int32 GWorld            = 0x068990C0;
	constexpr int32 ProcessEvent      = 0x01438130;

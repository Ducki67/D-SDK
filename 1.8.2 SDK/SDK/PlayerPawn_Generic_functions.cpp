...
// Parameters:
// const struct FTransform&                NewTransform                                           (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor)
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// EPlayerWindParticleEmitters             Player_Wind_Particle_Emitter_To_Fire                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void APlayerPawn_Generic_C::SpawnDBNOParticles(const struct FVector& ParticleLocation, const struct FVector& HitNormal)
{
	...
	Params::PlayerPawn_Generic_C_SpawnDBNOParticles Parms{};

	Parms.ParticleLocation = std::move(ParticleLocation);
...
void APlayerPawn_Generic_C::CharacterDestroyed(class AActor* DestroyedActor)
{
	...
	Params::PlayerPawn_Generic_C_CharacterDestroyed Parms{};
...
void APlayerPawn_Generic_C::GameplayCue_Abilities_Activation_DBNOResurrect(EGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	...
	Params::PlayerPawn_Generic_C_GameplayCue_Abilities_Activation_DBNOResurrect Parms{};
...
void APlayerPawn_Generic_C::SetAdrenalineRushVisibility(bool Visible)
{
	...
	Params::PlayerPawn_Generic_C_SetAdrenalineRushVisibility Parms{};

...
{
public:
	static void AddGameplayTag(struct FGameplayTagContainer& InOutTagContainer, const struct FGameplayTag& Tag);
	static bool AddGameplayTagToContainer(struct FGameplayTagContainer& TagContainer, const struct FGameplayTag& Tag);
...
public:
	...
	TArray<struct FStringAssetReference>          GameplayTagTableList;                              // 0x0068(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)

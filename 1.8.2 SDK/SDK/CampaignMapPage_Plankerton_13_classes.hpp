...
// WidgetBlueprintGeneratedClass CampaignMapPage_Plankerton_13.CampaignMapPage_Plankerton_13_C
// 0x0068 (0x02A0 - 0x0238)
class UCampaignMapPage_Plankerton_13_C final : public UCommonUserWidget
{
public:
	...
	class UQuestMiniTile_C*                       Q13;                                               // 0x0288(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UQuestMiniTile_C*                       Q14;                                               // 0x0290(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UQuestMiniTile_C*                       Q15;                                               // 0x0298(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)

public:
	void ExecuteUbergraph_CampaignMapPage_Plankerton_13(int32 EntryPoint);
	void Construct();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("CampaignMapPage_Plankerton_13_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"CampaignMapPage_Plankerton_13_C")
	}
	static class UCampaignMapPage_Plankerton_13_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCampaignMapPage_Plankerton_13_C>();
	}
};
DUMPER7_ASSERTS_UCampaignMapPage_Plankerton_13_C;

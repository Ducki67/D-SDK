...
struct FEventReply UAthenaInventoryPanel_C::OnKeyUp(const struct FGeometry& MyGeometry, const struct FKeyEvent& InKeyEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaInventoryPanel_C", "OnKeyUp");

	Params::AthenaInventoryPanel_C_OnKeyUp Parms{};

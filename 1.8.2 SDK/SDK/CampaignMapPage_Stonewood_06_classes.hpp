...
// WidgetBlueprintGeneratedClass CampaignMapPage_Stonewood_06.CampaignMapPage_Stonewood_06_C
// 0x0068 (0x02A0 - 0x0238)
class UCampaignMapPage_Stonewood_06_C final : public UCommonUserWidget
{
public:
	...
	class UImage*                                 Img_GasTrap;                                       // 0x0260(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
public:
	void ExecuteUbergraph_CampaignMapPage_Stonewood_06(int32 EntryPoint);
	void Construct();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("CampaignMapPage_Stonewood_06_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"CampaignMapPage_Stonewood_06_C")
	}
	static class UCampaignMapPage_Stonewood_06_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCampaignMapPage_Stonewood_06_C>();
	}
};
DUMPER7_ASSERTS_UCampaignMapPage_Stonewood_06_C;

...
public:
	...
	TDelegate<void(const int32 Wave, const TArray<struct FFortItemInstanceQuantityPair>& Rewards)> K2Node_CreateDelegate_OutputDelegate4; // 0x0190(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const TArray<struct FFortItemInstanceQuantityPair>& Items)> K2Node_CreateDelegate_OutputDelegate6; // 0x0228(0x0010)(ZeroConstructor, NoDestructor)
	...
	TDelegate<void(const TArray<class UFortGameplayModifierItemDefinition*>& AppliedModifiers)> K2Node_CreateDelegate_OutputDelegate7; // 0x0248(0x0010)(ZeroConstructor, NoDestructor)
...
DUMPER7_ASSERTS_HordeWaveAlertWidget_C_ExecuteUbergraph_HordeWaveAlertWidget;
...
DUMPER7_ASSERTS_HordeWaveAlertWidget_C_OnWaveModifiersAdded;
...
DUMPER7_ASSERTS_HordeWaveAlertWidget_C_OnHordeTierInitialized_Event_0;
...
DUMPER7_ASSERTS_HordeWaveAlertWidget_C_OnWaveCompleted;
...
DUMPER7_ASSERTS_HordeWaveAlertWidget_C_OnWaveStarted;

...
// WidgetBlueprintGeneratedClass CampaignMapPage_Plankerton_01.CampaignMapPage_Plankerton_01_C
// 0x0078 (0x02B0 - 0x0238)
class UCampaignMapPage_Plankerton_01_C final : public UCommonUserWidget
{
public:
	...
	class UImage*                                 Img_Material;                                      // 0x0260(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
public:
	void ExecuteUbergraph_CampaignMapPage_Plankerton_01(int32 EntryPoint);
	void Construct();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("CampaignMapPage_Plankerton_01_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"CampaignMapPage_Plankerton_01_C")
	}
	static class UCampaignMapPage_Plankerton_01_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCampaignMapPage_Plankerton_01_C>();
	}
};
DUMPER7_ASSERTS_UCampaignMapPage_Plankerton_01_C;

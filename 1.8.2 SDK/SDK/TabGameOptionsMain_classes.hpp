...
public:
	...
	class UOptionsMenuSlider_C*                   ControllerLookSensitivityX;                        // 0x02C0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOptionsMenuSlider_C*                   ControllerLookSensitivityY;                        // 0x02C8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class URotatorSelector_C*                     First_PersonCamera;                                // 0x02D8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
public:
	...
	void BndEvt__ConsoleUnlockedFPS_K2Node_ComponentBoundEvent_110_Selection_Changed__DelegateSignature(int32 Selected_Index);
